...
return [
    ...
    */
    'auth' => [
        ...
        'controller' => CraCkzer\Backport\Controllers\AuthController::class,
        ...
        'providers' => [
            'backport' => [
                'driver' => 'eloquent',
                'model'  => CraCkzer\Backport\Auth\Database\Administrator::class,
            ],
        ],
    ...
    */
    'database' => [
        ...
        'users_model' => CraCkzer\Backport\Auth\Database\Administrator::class,

        // Role table and model.
        'roles_table' => 'backport_roles',
        'roles_model' => CraCkzer\Backport\Auth\Database\Role::class,

        // Permission table and model.
        'permissions_table' => 'backport_permissions',
        'permissions_model' => CraCkzer\Backport\Auth\Database\Permission::class,

        // Menu table and model.
        'menu_table' => 'backport_menu',
        'menu_model' => CraCkzer\Backport\Auth\Database\Menu::class,
