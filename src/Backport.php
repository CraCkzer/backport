...
namespace CraCkzer\Backport;

use Closure;
use CraCkzer\Backport\Controllers\AuthController;
use CraCkzer\Backport\Layout\Content;
use CraCkzer\Backport\Traits\HasAssets;
use CraCkzer\Backport\Widgets\Navbar;
...
class Backport
{
     ...
     * @param Closure $callable
     *
     * @return \CraCkzer\Backport\Settings
     *
     *  @deprecated since v1.6.1
     */
     ...
     * @param Closure $callable
     *
     * @return \CraCkzer\Backport\Layout\Content
     *
     * @deprecated since v1.6.1
     */
     ...
     * Get navbar object.
     *
     * @return \CraCkzer\Backport\Widgets\Navbar
     */
    ...
    public function registerAuthRoutes()
    {
        ...
        app('router')->group($attributes, function ($router) {
            ...
            $router->namespace('CraCkzer\Backport\Controllers')->group(function ($router) {
    ...
    public function registerLogRoutes()
    {
        ...
        app('router')->group($attributes, function ($router) {
            /* @var \Illuminate\Routing\Router $router */
            $router->namespace('CraCkzer\Backport\Controllers\Logs')->group(function ($router) {
