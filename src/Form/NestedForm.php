...
namespace CraCkzer\Backport\Form;

use CraCkzer\Backport\Backport;
...
class NestedForm
{
    ...
    protected function prepareRecord($record)
    {
        ...
        foreach ($this->fields as $field) {
            ...
            if (($field instanceof \CraCkzer\Backport\Form\Field\Hidden) || $value != $field->original()) {
                if (is_array($columns)) {
