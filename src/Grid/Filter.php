...
namespace CraCkzer\Backport\Grid;

use CraCkzer\Backport\Grid\Filter\AbstractFilter;
use CraCkzer\Backport\Grid\Filter\Group;
use CraCkzer\Backport\Grid\Filter\Layout\Layout;
use CraCkzer\Backport\Grid\Filter\Scope;
...
class Filter implements Renderable
{
    ...
    public function __call($method, $arguments)
    {
        if (in_array($method, $this->supports)) {
            $className = '\\CraCkzer\\Backport\\Grid\\Filter\\'.ucfirst($method);
