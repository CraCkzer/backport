...
use Closure;
use CraCkzer\Backport\Exception\Handler;
use CraCkzer\Backport\Grid\Column;
use CraCkzer\Backport\Grid\Displayers;
use CraCkzer\Backport\Grid\Exporter;
use CraCkzer\Backport\Grid\Exporters\AbstractExporter;
use CraCkzer\Backport\Grid\Filter;
use CraCkzer\Backport\Grid\HasElementNames;
use CraCkzer\Backport\Grid\Model;
use CraCkzer\Backport\Grid\Row;
use CraCkzer\Backport\Grid\Tools;
...
class Grid
{
     ...
     *
     * @var \CraCkzer\Backport\Grid\Model
     */
    protected $model;
     ...
     * The grid Filter.
     *
     * @var \CraCkzer\Backport\Grid\Filter
     */
    protected $filter;
