...
namespace CraCkzer\Backport\Controllers;

use CraCkzer\Backport\Form;
use CraCkzer\Backport\Layout\Column;
use CraCkzer\Backport\Layout\Content;
use CraCkzer\Backport\Layout\Row;
use CraCkzer\Backport\Tree;
use CraCkzer\Backport\Widgets\Box;
        ...
        return $content
            ...
            ->row(function (Row $row) {
                ...
                $row->column(6, function (Column $column) {
                    $form = new \CraCkzer\Backport\Widgets\Form();
