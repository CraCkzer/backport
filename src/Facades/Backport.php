...
namespace CraCkzer\Backport\Facades;
 ...
 * Class Admin.
 *
 * @method static \CraCkzer\Backport\Grid grid($model, \Closure $callable)
 * @method static \CraCkzer\Backport\Form form($model, \Closure $callable)
 * @method static \CraCkzer\Backport\Show show($model, $callable = null)
 * @method static \CraCkzer\Backport\Tree tree($model, \Closure $callable = null)
 * @method static \CraCkzer\Backport\Layout\Content content(\Closure $callable = null)
...
class Backport extends Facade
{
    ...
    {
        return \CraCkzer\Backport\Backport::class;
    }
}
